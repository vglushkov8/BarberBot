...
def get_first_slot_date() -> datetime:
...
def get_all_slots_during_day(first_slot_date) -> List[datetime]:
...
def get_all_slots() -> List[datetime]:
...
def chosen_slot_to_date(slot_str: str) -> datetime:
